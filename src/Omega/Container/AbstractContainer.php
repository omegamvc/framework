 ...
 */
class AbstractContainer implements ContainerInterface, FactoryInterface, InvokerInterface
{
    ...
    public function __construct(
        ...
        $this->definitionResolver = new ResolverDispatcher($this->delegateContainer, new NativeProxyFactory());
