 ...
 * This usage applied on an element effectively means that the object has 2 fields, the names are <code>"age"</code>
 * and <code>"name"</code>, and the corresponding types are <code>"int"</code> and <code>"string"</code>.
 */
#[Attribute(
