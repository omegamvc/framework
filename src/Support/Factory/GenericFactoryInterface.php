...
interface GenericFactoryInterface
{
     ...
     *
     * @param array|null $config Holds an optional configuration array that may be used to influence the creation of the
     * object. If no configuration is provided, default settings may be applied.
