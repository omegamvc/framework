...
if (!function_exists('model_path')) {
    ...
    {
        $path = helper . phpapp()->modelPath() . $surfix_path;
...
if (!function_exists('view_path')) {
    ...
    {
        $path = helper . phpapp()->viewPath() . $surfix_path;
...
if (!function_exists('controllers_path')) {
    ...
    {
        $path = helper . phpapp()->controllerPath() . $surfix_path;
...
if (!function_exists('services_path')) {
    ...
    {
        $path = helper . phpapp()->servicesPath() . $surfix_path;
...
if (!function_exists('component_path')) {
    ...
    {
        $path = helper . phpapp()->componentPath() . $surfix_path;
...
if (!function_exists('commands_path')) {
    ...
    {
        $path = helper . phpapp()->commandPath() . $surfix_path;
...
if (!function_exists('storage_path')) {
    ...
    {
        $path = helper . phpapp()->storagePath() . $surfix_path;
...
if (!function_exists('cache_path')) {
    ...
    {
        $path = helper . phpapp()->cachePath() . $surfix_path;
...
if (!function_exists('config_path')) {
    ...
    {
        $path = helper . phpapp()->configPath() . $surfix_path;
...
if (!function_exists('middleware_path')) {
    ...
    {
        $path = helper . phpapp()->middlewarePath() . $surfix_path;
...
if (!function_exists('provider_path')) {
    ...
    {
        $path = helper . phpapp()->providerPath() . $surfix_path;
...
if (!function_exists('migration_path')) {
    ...
    {
        $path = helper . phpapp()->migrationPath() . $surfix_path;
...
if (!function_exists('seeder_path')) {
    ...
    {
        $path = helper . phpapp()->seederPath() . $surfix_path;
...
if (!function_exists('base_path')) {
    ...
    {
        return helper . phpapp()->basePath() . $insert_path;
    }
}
