...
use Omega\Exception\Handler\CallbackHandler;
use Omega\Exception\Handler\Handler;
use Omega\Exception\Handler\HandlerInterface;
use Omega\Exception\Inspector\CallableInspectorFactory;
use Omega\Exception\Inspector\InspectorFactory;
use Omega\Exception\Inspector\InspectorFactoryInterface;
use Omega\Exception\Inspector\InspectorInterface;
use Omega\Exception\Util\Misc;
use Omega\Exception\Util\SystemFacade;
...
final class Run implements RunInterface
{
    ...
    public function register()
    {
        if (!$this->isRegistered) {
            ...
            class_exists("\\Omega\\Exception\\Exception\\ErrorException");
            class_exists("\\Omega\\Exception\\Frame\\FrameCollection");
            class_exists("\\Omega\\Exception\\Frame\\Frame");
            class_exists("\\Omega\\Exception\\Inspector\\Inspector");
            class_exists("\\Omega\\Exception\\Inspector\\InspectorFactory");
    ...
    /**
     * Unregisters all handlers registered by this Run instance.
     *
     * @return Run
     */
    ...
    /**
     * Should allow Handlers to force the script to quit?
     *
     * @param bool|int $exit
     *
     * @return bool
    ...
    /**
     * Should send HTTP error code to the browser if possible?
     * By default send HTTP code 500, but you may wish to
    ...
    /**
     * Should exit with a specific code on the CLI if possible?
     * Exit with 1 by default, but you can specify something else.
     *
     * @param int $code
     *
     * @return int
    ...
    /**
     * Should push output directly to the client?
    ...
    /**
     * Handles an exception, ultimately generating a error page.
     *
    ...
    public function handleError($level, $message, $file = null, $line = null)
    {
        if ($level & $this->system->getErrorReportingLevel()) {
            ...
            // Do not propagate errors which were already handled by error handler.
            return true;
        }
    ...
    private function resolveHandler($handler)
    {
        ...
        if (!$handler instanceof HandlerInterface) {
            throw new InvalidArgumentException(
                ...
                . "Omega\\Exception\\Handler\\HandlerInterface"
            );
        }
