...
use Omega\Exception\Frame\FrameCollection;
...
class Inspector implements InspectorInterface
{
    ...
    /**
     * Returns an url to the php-manual related to the underlying error - when available.
     *
     * @return string|null
     */
    ...
    private function extractDocrefUrl($message)
    {
        ...
        // php embeds urls to the manual into the Exception message with the following ini-settings defined
