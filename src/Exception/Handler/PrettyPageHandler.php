...
class PrettyPageHandler extends Handler
{
     ...
     * @var string
     */
    private $pageTitle = "Omega error reporting.";
     ...
     *
     * @return \Omega\Exception\Frame\FrameCollection
     */
